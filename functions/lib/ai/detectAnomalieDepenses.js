...
exports.detectAnomalieDepenses = void 0;
 ...
 */
exports.detectAnomalieDepenses = (0, firestore_1.onDocumentWritten)('projets/{projectId}/depenses/{depenseId}', async (event) => {
        ...
        if (count > 5) { // Need a minimum sample size to be statistically significant
            ...
            if (montant > (moyenne * seuil)) {
                ...
                if (clientId) {
                    ...
                    await (0, fcmService_1.sendNotificationToUser)(clientId, '⚠️ Alerte IA: Dépense Anormale', `Une dépense de ${montant}€ a été détectée comme anormale sur votre chantier.`, 'alerte_ia', projectId);
                }
            }
        }
    }
...
//# sourceMappingURL=detectAnomalieDepenses.js.map