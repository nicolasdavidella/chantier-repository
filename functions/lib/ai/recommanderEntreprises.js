...
exports.recommanderEntreprises = void 0;
 ...
 */
exports.recommanderEntreprises = (0, https_1.onCall)(async (request) => {
    const data = request.data;
    const { localisation, type_construction, budget } = data;
    try {
        ...
        const recommandations = entreprises.map(entreprise => {
            ...
            const specialites = entreprise.specialites || [];
            ...
            const zones = entreprise.zonesIntervention || [];
            ...
            score += (noteMoyenne * 2);
            if (noteMoyenne >= 4.0)
                matchingReasons.push('Excellente évaluation client');
...
//# sourceMappingURL=recommanderEntreprises.js.map